...
public class SectionsController implements Initializable {
    ...
    @FXML
    private TableColumn<section, String> typeCol;
    @FXML
    private TableColumn<section, String> editCol;
    ...
    private void getAddView(MouseEvent event) {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("AddSection.fxml"));
    ...
    private void showData() {
        ...
        table_section.setItems((ObservableList<section>) ip.afficher());
    }
    ...
    private void loadDate() {
        ...
        Callback<TableColumn<section, String>, TableCell<section, String>> cellFoctory;
        cellFoctory = (TableColumn<section, String> param) -> {
            // make cell containing buttons
            final TableCell<section, String> cell;
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        deleteIcon.setOnMouseClicked((MouseEvent event) -> {
                            section  sc =table_section.getSelectionModel().getSelectedItem();
                            Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
                            alert.initStyle(StageStyle.TRANSPARENT);
                            alert.setTitle(null);
                            alert.setHeaderText("Supprimer " + sc.getNom() +"  ?");
                            ...
                            if (action.get() == ButtonType.CANCEL) {
                                ...
                                Iservices ip =  new Servicesection();
                                ip.supprimer(sc);
                                 showData();
                                ...
                                notificationBuilder.text(sc.getNom() + " Supprimer avec succées");
...
//                            }
                        ...
                        editIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            section m  = (section) table_section.getSelectionModel().getSelectedItem();
                            FXMLLoader loader = new FXMLLoader();
                            loader.setLocation(getClass().getResource("AddSection.fxml"));
                            try {
                                loader.load();
                            } catch (IOException ex) {
                                Logger.getLogger(SectionsController.class.getName()).log(Level.SEVERE, null, ex);
                            }

                            AddSectionController AddCategorieController = loader.getController();
        ...
        table_section.setItems(sectionList);
